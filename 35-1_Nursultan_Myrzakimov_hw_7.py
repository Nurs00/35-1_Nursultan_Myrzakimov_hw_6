...
def create_products(conn):
    create_product(conn, ('Tea', 120, 100))
    create_product(conn, ('Lays', 140, 100))
    create_product(conn, ('Pir', 102.5, 100))
    create_product(conn, ('Nitro', 72.5, 100))
    create_product(conn, ('Flash', 62.5, 100))
